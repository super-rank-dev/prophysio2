                        ...
                        {patients.map((patient) => {
                            return (
                                <ListItem
                                    ...
                                    secondaryAction={
                                        <>
                                            <IconButton edge="end" onClick={() => sendIntakeForm(patient)}><ForwardToInboxIcon /></IconButton>
                                            <IconButton edge="end" sx={{ marginX: 1 }} onClick={() => removePatient(patient._id)}><DeleteIcon /></IconButton>
                                        </>
                                    }
                                >
                                    <ListItemButton>
